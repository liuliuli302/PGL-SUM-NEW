...
save_dir = Path("../PGL-SUM-NEW/Summaries/PGL-SUM/exp1")
...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument(
        "--fusion", type=str, default="add", help="Type of feature fusion"
    )
    parser.add_argument(
        "--n_segments",
        type=int,
    ...
    parser.add_argument(
        "--lr", type=float, default=5e-5, help="Learning rate used for the modules"
    )
    parser.add_argument(
        "--l2_req", type=float, default=1e-5, help="Regularization factor"
    )
    parser.add_argument(
