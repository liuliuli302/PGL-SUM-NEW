...
class VideoData(Dataset):
    def __init__(self, mode, video_type, split_index):
        ...
        self.datasets = ['../PGL-SUM-Modify/data/datasets/SumMe/eccv16_dataset_summe_google_pool5.h5',
                         '../PGL-SUM-Modify/data/datasets/TVSum/eccv16_dataset_tvsum_google_pool5.h5']
        self.splits_filename = ['../PGL-SUM-Modify/data/datasets/splits/' + self.name + '_splits.json']
